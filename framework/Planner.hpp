...
const float PLANNER_G_MOD = 1;
const float PLANNER_H_MOD = 1;
...
namespace rz::planner
{
	...
	*/
    ...
    using ActionGraph = rz::graph::Graph<Node, int, int>;
    using ActionVertex = rz::graph::Vertex<Node, int>;
    using ActionEdge = rz::graph::Edge<int>;
    /*! @endcond */
