...
TaskScheduler::TaskScheduler() noexcept
    : _nextTaskID{ 1 }, _openTasks{}, _pendingTasks{}, _threads{}, _taskQueueMutex{}, _hasWorkCondition{}, _isEnd{}, _hasOpenWork{}, _hasWork{}
{
...
Task TaskScheduler::pushGraph(WorkGraph workGraph, Task dependency)
{
    ...
    auto fillTaskList = [this, &tasks, &parents, &dependency](WorkGraphVertex &v, WorkGraph &g) {
        ...
        const auto pushTasks = [this, &v, &tasks, &parents](std::size_t depID) {
