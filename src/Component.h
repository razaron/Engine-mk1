...
/*! A Component carries the data for a specific feature. */
namespace razaron::core::component
{
	/*! Denotes the type of a Component object. */
	...
	/*! A map type mapping Component Handle%s to their ComponentType%s. */
